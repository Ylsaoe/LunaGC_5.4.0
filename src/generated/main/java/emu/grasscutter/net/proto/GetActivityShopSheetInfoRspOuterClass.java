...
public final class GetActivityShopSheetInfoRspOuterClass {
  ...
  public interface GetActivityShopSheetInfoRspOrBuilder extends
    ...
    /**
     * <code>repeated .ActivityShopSheetInfo sheet_info_list = 2;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int SHEET_INFO_LIST_FIELD_NUMBER = 2;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < sheetInfoList_.size(); i++) {
        output.writeMessage(2, sheetInfoList_.get(i));
      }
      if (retcode_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < sheetInfoList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(2, sheetInfoList_.get(i));
      }
      if (retcode_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "hopSheetInfoRsp\022/\n\017sheet_info_list\030\002 \003(\013" +
      "2\026.ActivityShopSheetInfo\022\017\n\007retcode\030\004 \001(" +
    ...
    internal_static_GetActivityShopSheetInfoRsp_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_GetActivityShopSheetInfoRsp_descriptor,
        new java.lang.String[] { "SheetInfoList", "Retcode", "ShopType", });
    emu.grasscutter.net.proto.ActivityShopSheetInfoOuterClass.getDescriptor();
  }
