...
public final class ClientLoadingCostumeVerificationNotifyOuterClass {
  ...
  public interface ClientLoadingCostumeVerificationNotifyOrBuilder extends
    ...
    /**
     * <code>uint64 BGNGHGKDCLF = 14;</code>
     * @return The bGNGHGKDCLF.
     */
    long getBGNGHGKDCLF();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int BGNGHGKDCLF_FIELD_NUMBER = 14;
    private long bGNGHGKDCLF_;
    /**
     * <code>uint64 BGNGHGKDCLF = 14;</code>
     * @return The bGNGHGKDCLF.
     */
    @java.lang.Override
    public long getBGNGHGKDCLF() {
      return bGNGHGKDCLF_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (bGNGHGKDCLF_ != 0L) {
        output.writeUInt64(14, bGNGHGKDCLF_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (bGNGHGKDCLF_ != 0L) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt64Size(14, bGNGHGKDCLF_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getBGNGHGKDCLF()
          != other.getBGNGHGKDCLF()) return false;
      if (getGuid()
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + BGNGHGKDCLF_FIELD_NUMBER;
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.ClientLoadingCostumeVerificationNotifyOuterClass.ClientLoadingCostumeVerificationNotify buildPartial() {
        ...
        result.bGNGHGKDCLF_ = bGNGHGKDCLF_;
        result.guid_ = guid_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.ClientLoadingCostumeVerificationNotifyOuterClass.ClientLoadingCostumeVerificationNotify other) {
        ...
        if (other.getBGNGHGKDCLF() != 0L) {
          setBGNGHGKDCLF(other.getBGNGHGKDCLF());
        }
        if (other.getGuid() != 0L) {
      ...
      /**
       * <code>uint64 BGNGHGKDCLF = 14;</code>
       * @param value The bGNGHGKDCLF to set.
       * @return This builder for chaining.
       */
      public Builder setBGNGHGKDCLF(long value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearBGNGHGKDCLF() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "onNotify\022\022\n\ncostume_id\030\005 \001(\r\022\023\n\013BGNGHGKD" +
      "CLF\030\016 \001(\004\022\014\n\004guid\030\t \001(\004B\033\n\031emu.grasscutt" +
    ...
    internal_static_ClientLoadingCostumeVerificationNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_ClientLoadingCostumeVerificationNotify_descriptor,
        new java.lang.String[] { "CostumeId", "BGNGHGKDCLF", "Guid", });
  }
