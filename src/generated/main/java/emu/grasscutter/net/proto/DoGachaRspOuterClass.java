...
public final class DoGachaRspOuterClass {
  ...
  public interface DoGachaRspOrBuilder extends
    ...
    /**
     * <code>bool DEGLFHCGLGG = 117;</code>
     * @return The dEGLFHCGLGG.
     */
    boolean getDEGLFHCGLGG();

    /**
     * <code>bool CCJDBPNJKKL = 1783;</code>
     * @return The cCJDBPNJKKL.
     */
    boolean getCCJDBPNJKKL();

    /**
     * <code>bool AKGBNPEPKOG = 805;</code>
     * @return The aKGBNPEPKOG.
     */
    boolean getAKGBNPEPKOG();
    ...
    /**
     * <code>uint32 gacha_times_limit = 9;</code>
    ...
    /**
     * <code>uint32 cur_schedule_daily_gacha_times = 678;</code>
    ...
    /**
     * <code>uint32 JDOPGOKKNKF = 229;</code>
     * @return The jDOPGOKKNKF.
     */
    int getJDOPGOKKNKF();
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 936: {
              ...
              dEGLFHCGLGG_ = input.readBool();
              break;
            }
            case 1832: {

              jDOPGOKKNKF_ = input.readUInt32();
              break;
            }
            case 5424: {
            ...
            case 6440: {
              ...
              aKGBNPEPKOG_ = input.readBool();
              break;
            }
            case 14264: {

              cCJDBPNJKKL_ = input.readBool();
              break;
            }
            default: {
    ...
    public static final int GACHA_ITEM_LIST_FIELD_NUMBER = 7;
    ...
    public static final int DEGLFHCGLGG_FIELD_NUMBER = 117;
    private boolean dEGLFHCGLGG_;
    /**
     * <code>bool DEGLFHCGLGG = 117;</code>
     * @return The dEGLFHCGLGG.
     */
    @java.lang.Override
    public boolean getDEGLFHCGLGG() {
      return dEGLFHCGLGG_;
    }

    public static final int CCJDBPNJKKL_FIELD_NUMBER = 1783;
    private boolean cCJDBPNJKKL_;
    /**
     * <code>bool CCJDBPNJKKL = 1783;</code>
     * @return The cCJDBPNJKKL.
     */
    @java.lang.Override
    public boolean getCCJDBPNJKKL() {
      return cCJDBPNJKKL_;
    }

    public static final int AKGBNPEPKOG_FIELD_NUMBER = 805;
    private boolean aKGBNPEPKOG_;
    /**
     * <code>bool AKGBNPEPKOG = 805;</code>
     * @return The aKGBNPEPKOG.
     */
    @java.lang.Override
    public boolean getAKGBNPEPKOG() {
      return aKGBNPEPKOG_;
    }
    ...
    public static final int GACHA_TIMES_LIMIT_FIELD_NUMBER = 9;
    ...
    public static final int CUR_SCHEDULE_DAILY_GACHA_TIMES_FIELD_NUMBER = 678;
    ...
    public static final int JDOPGOKKNKF_FIELD_NUMBER = 229;
    private int jDOPGOKKNKF_;
    /**
     * <code>uint32 JDOPGOKKNKF = 229;</code>
     * @return The jDOPGOKKNKF.
     */
    @java.lang.Override
    public int getJDOPGOKKNKF() {
      return jDOPGOKKNKF_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < gachaItemList_.size(); i++) {
        output.writeMessage(7, gachaItemList_.get(i));
      }
      if (tenCostItemNum_ != 0) {
        output.writeUInt32(8, tenCostItemNum_);
      }
      if (gachaTimesLimit_ != 0) {
        output.writeUInt32(9, gachaTimesLimit_);
      }
      if (wishItemId_ != 0) {
      ...
      if (dEGLFHCGLGG_ != false) {
        output.writeBool(117, dEGLFHCGLGG_);
      }
      if (jDOPGOKKNKF_ != 0) {
        output.writeUInt32(229, jDOPGOKKNKF_);
      }
      if (curScheduleDailyGachaTimes_ != 0) {
        output.writeUInt32(678, curScheduleDailyGachaTimes_);
      }
      if (aKGBNPEPKOG_ != false) {
        output.writeBool(805, aKGBNPEPKOG_);
      }
      if (cCJDBPNJKKL_ != false) {
        output.writeBool(1783, cCJDBPNJKKL_);
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < gachaItemList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(7, gachaItemList_.get(i));
      }
      if (tenCostItemNum_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (gachaTimesLimit_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(9, gachaTimesLimit_);
      }
      if (wishItemId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (dEGLFHCGLGG_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(117, dEGLFHCGLGG_);
      }
      if (jDOPGOKKNKF_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(229, jDOPGOKKNKF_);
      }
      if (curScheduleDailyGachaTimes_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(678, curScheduleDailyGachaTimes_);
      }
      if (aKGBNPEPKOG_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(805, aKGBNPEPKOG_);
      }
      if (cCJDBPNJKKL_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(1783, cCJDBPNJKKL_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getDEGLFHCGLGG()
          != other.getDEGLFHCGLGG()) return false;
      if (getCCJDBPNJKKL()
          != other.getCCJDBPNJKKL()) return false;
      if (getAKGBNPEPKOG()
          != other.getAKGBNPEPKOG()) return false;
      if (getGachaType()
      ...
      if (getJDOPGOKKNKF()
          != other.getJDOPGOKKNKF()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + DEGLFHCGLGG_FIELD_NUMBER;
      hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
          getDEGLFHCGLGG());
      hash = (37 * hash) + CCJDBPNJKKL_FIELD_NUMBER;
      hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
          getCCJDBPNJKKL());
      hash = (37 * hash) + AKGBNPEPKOG_FIELD_NUMBER;
      hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
          getAKGBNPEPKOG());
      ...
      hash = (37 * hash) + JDOPGOKKNKF_FIELD_NUMBER;
      hash = (53 * hash) + getJDOPGOKKNKF();
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.DoGachaRspOuterClass.DoGachaRsp buildPartial() {
        ...
        result.dEGLFHCGLGG_ = dEGLFHCGLGG_;
        result.cCJDBPNJKKL_ = cCJDBPNJKKL_;
        result.aKGBNPEPKOG_ = aKGBNPEPKOG_;
        ...
        result.jDOPGOKKNKF_ = jDOPGOKKNKF_;
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.DoGachaRspOuterClass.DoGachaRsp other) {
        ...
        if (other.getDEGLFHCGLGG() != false) {
          setDEGLFHCGLGG(other.getDEGLFHCGLGG());
        }
        if (other.getCCJDBPNJKKL() != false) {
          setCCJDBPNJKKL(other.getCCJDBPNJKKL());
        }
        if (other.getAKGBNPEPKOG() != false) {
          setAKGBNPEPKOG(other.getAKGBNPEPKOG());
        }
        ...
        if (other.getJDOPGOKKNKF() != 0) {
          setJDOPGOKKNKF(other.getJDOPGOKKNKF());
        }
      ...
      /**
       * <code>bool DEGLFHCGLGG = 117;</code>
       * @param value The dEGLFHCGLGG to set.
       * @return This builder for chaining.
       */
      public Builder setDEGLFHCGLGG(boolean value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearDEGLFHCGLGG() {
      ...
      /**
       * <code>bool CCJDBPNJKKL = 1783;</code>
       * @param value The cCJDBPNJKKL to set.
       * @return This builder for chaining.
       */
      public Builder setCCJDBPNJKKL(boolean value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearCCJDBPNJKKL() {
      ...
      /**
       * <code>bool AKGBNPEPKOG = 805;</code>
       * @param value The aKGBNPEPKOG to set.
       * @return This builder for chaining.
       */
      public Builder setAKGBNPEPKOG(boolean value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearAKGBNPEPKOG() {
      ...
      /**
       * <code>uint32 JDOPGOKKNKF = 229;</code>
       * @param value The jDOPGOKKNKF to set.
       * @return This builder for chaining.
       */
      public Builder setJDOPGOKKNKF(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearJDOPGOKKNKF() {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\020DoGachaRsp.proto\032\017GachaItem.proto\"\377\003\n\n" +
      "DoGachaRsp\022#\n\017gacha_item_list\030\007 \003(\0132\n.Ga" +
      "chaItem\022\023\n\013gacha_times\030\014 \001(\r\022\023\n\013DEGLFHCG" +
      "LGG\030u \001(\010\022\024\n\013CCJDBPNJKKL\030\367\r \001(\010\022\024\n\013AKGBN" +
      "PEPKOG\030\245\006 \001(\010\022\022\n\ngacha_type\030\001 \001(\r\022\031\n\021gac" +
      "ha_times_limit\030\t \001(\r\022\024\n\014cost_item_id\030\013 \001" +
      "(\r\022\'\n\036cur_schedule_daily_gacha_times\030\246\005 " +
      "\001(\r\022\025\n\rcost_item_num\030\003 \001(\r\022\030\n\020ten_cost_i" +
      "tem_id\030\005 \001(\r\022\030\n\020left_gacha_times\030\004 \001(\r\022\024" +
      "\n\014wish_item_id\030\n \001(\r\022\017\n\007retcode\030\r \001(\005\022\031\n" +
      "\021ten_cost_item_num\030\010 \001(\r\022\031\n\021wish_max_pro" +
      "gress\030\016 \001(\r\022\024\n\013JDOPGOKKNKF\030\345\001 \001(\r\022\031\n\021gac" +
      "ha_schedule_id\030\006 \001(\r\022\025\n\rwish_progress\030\017 " +
      "\001(\r\022\030\n\020new_gacha_random\030\002 \001(\rB\033\n\031emu.gra" +
    ...
    internal_static_DoGachaRsp_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_DoGachaRsp_descriptor,
        new java.lang.String[] { "GachaItemList", "GachaTimes", "DEGLFHCGLGG", "CCJDBPNJKKL", "AKGBNPEPKOG", "GachaType", "GachaTimesLimit", "CostItemId", "CurScheduleDailyGachaTimes", "CostItemNum", "TenCostItemId", "LeftGachaTimes", "WishItemId", "Retcode", "TenCostItemNum", "WishMaxProgress", "JDOPGOKKNKF", "GachaScheduleId", "WishProgress", "NewGachaRandom", });
    emu.grasscutter.net.proto.GachaItemOuterClass.getDescriptor();
  }
