...
public final class PlayerEnterDungeonReqOuterClass {
  ...
  public interface PlayerEnterDungeonReqOrBuilder extends
    ...
    /**
     * <code>bool LDJAELKEILL = 5;</code>
     * @return The lDJAELKEILL.
     */
    boolean getLDJAELKEILL();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int LDJAELKEILL_FIELD_NUMBER = 5;
    private boolean lDJAELKEILL_;
    /**
     * <code>bool LDJAELKEILL = 5;</code>
     * @return The lDJAELKEILL.
     */
    @java.lang.Override
    public boolean getLDJAELKEILL() {
      return lDJAELKEILL_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (lDJAELKEILL_ != false) {
        output.writeBool(5, lDJAELKEILL_);
      }
      if (enterPosInfo_ != null) {
    ...
    public int getSerializedSize() {
      ...
      if (lDJAELKEILL_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(5, lDJAELKEILL_);
      }
      if (enterPosInfo_ != null) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getLDJAELKEILL()
          != other.getLDJAELKEILL()) return false;
      if (getPointId()
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + LDJAELKEILL_FIELD_NUMBER;
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.PlayerEnterDungeonReqOuterClass.PlayerEnterDungeonReq buildPartial() {
        ...
        result.lDJAELKEILL_ = lDJAELKEILL_;
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.PlayerEnterDungeonReqOuterClass.PlayerEnterDungeonReq other) {
        ...
        if (other.getLDJAELKEILL() != false) {
          setLDJAELKEILL(other.getLDJAELKEILL());
        }
      ...
      /**
       * <code>bool LDJAELKEILL = 5;</code>
       * @param value The lDJAELKEILL to set.
       * @return This builder for chaining.
       */
      public Builder setLDJAELKEILL(boolean value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearLDJAELKEILL() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "eq\022,\n\016enter_pos_info\030\006 \001(\0132\024.DungeonEnte" +
      "rPosInfo\022\022\n\ndungeon_id\030\n \001(\r\022\023\n\013LDJAELKE" +
      "ILL\030\005 \001(\010\022\020\n\010point_id\030\t \001(\rB\033\n\031emu.grass" +
    ...
    internal_static_PlayerEnterDungeonReq_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_PlayerEnterDungeonReq_descriptor,
        new java.lang.String[] { "EnterPosInfo", "DungeonId", "LDJAELKEILL", "PointId", });
    emu.grasscutter.net.proto.DungeonEnterPosInfoOuterClass.getDescriptor();
  }
