...
public final class LockedPersonallineDataOuterClass {
  ...
  public interface LockedPersonallineDataOrBuilder extends
    ...
    /**
     * <code>.LockedPersonallineData.LockReason lock_reason = 15;</code>
    ...
    /**
     * <code>.LockedPersonallineData.QuestParam quest_param = 5;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int LOCK_REASON_FIELD_NUMBER = 15;
    ...
    public static final int QUEST_PARAM_FIELD_NUMBER = 5;
    /**
     * <code>.LockedPersonallineData.QuestParam quest_param = 5;</code>
     * @return Whether the questParam field is set.
     */
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (paramCase_ == 5) {
        output.writeMessage(5, (emu.grasscutter.net.proto.LockedPersonallineDataOuterClass.LockedPersonallineData.QuestParam) param_);
      }
      if (paramCase_ == 11) {
        output.writeUInt32(
      ...
      if (lockReason_ != emu.grasscutter.net.proto.LockedPersonallineDataOuterClass.LockedPersonallineData.LockReason.LockReason_LEVEL.getNumber()) {
        output.writeEnum(15, lockReason_);
      }
      unknownFields.writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      if (paramCase_ == 5) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(5, (emu.grasscutter.net.proto.LockedPersonallineDataOuterClass.LockedPersonallineData.QuestParam) param_);
      }
      if (paramCase_ == 11) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(
      ...
      if (lockReason_ != emu.grasscutter.net.proto.LockedPersonallineDataOuterClass.LockedPersonallineData.LockReason.LockReason_LEVEL.getNumber()) {
        size += com.google.protobuf.CodedOutputStream
          .computeEnumSize(15, lockReason_);
      }
      size += unknownFields.getSerializedSize();
      memoizedSize = size;
      return size;
    ...
    public static final class Builder extends
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.LockedPersonallineDataOuterClass.LockedPersonallineData.QuestParamOrBuilder getQuestParamOrBuilder() {
        if ((paramCase_ == 5) && (questParamBuilder_ != null)) {
