...
public enum QuestContent implements QuestTrigger {
    ...
    QUEST_CONTENT_ACHIEVEMENT_STATE_EQUAL(157),
    QUEST_CONTENT_ACHIEVEMENT_ISACHIEVED(158),
    QUEST_CONTENT_EVENTS_ITEM_STATUS(159),
    QUEST_CONTENT_QUEST_GLOBAL_VAR_EQUAL(160),
    QUEST_CONTENT_QUEST_GLOBAL_VAR_NOT_EQUAL(161),
    QUEST_CONTENT_QUEST_GLOBAL_VAR_GREATER(162),
    QUEST_CONTENT_QUEST_CHECK_EQUAL(163),
    QUEST_CONTENT_GCG_LEVEL_WIN(164),
    QUEST_CONTENT_ITEM_NUM_EQUAL(165),
    QUEST_CONTENT_EXHIBITION_ACCUMULATE_GT_EQ(166),
    QUEST_CONTENT_SHOP_SELL_OUT(167),
    QUEST_COND_UNKNOWN(168),
